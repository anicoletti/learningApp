...
const WASM_BIN_URL = new URL( '../libs/basis/basis_transcoder.wasm', ({env:{MODE:"production"}} /* removed import.meta */).url ).toString();
const WASM_JS_URL = new URL( '../libs/basis/basis_transcoder.js', ({env:{MODE:"production"}} /* removed import.meta */).url ).toString();
