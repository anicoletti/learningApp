...
const WASM_BIN_URL = new URL( '../libs/draco/draco_decoder.wasm', ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed import.meta */) */) */).url ).toString();
const WASM_JS_URL = new URL( '../libs/draco/draco_wasm_wrapper.js', ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed import.meta */) */) */).url ).toString();
const JS_URL = new URL( '../libs/draco/draco_decoder.js', ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed import.meta */) */) */).url ).toString();

const DRACO_GLTF_CONFIG = {
	js: new URL( '../libs/draco/gltf/draco_wasm_wrapper.js', ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed import.meta */) */) */).url ).toString(),
	wasm: new URL( '../libs/draco/gltf/draco_decoder.wasm', ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed ({env:{MODE:"production"}} /* removed import.meta */) */) */).url ).toString(),
};
