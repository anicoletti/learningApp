...
const WASM_BIN_URL = new URL( '../libs/draco/draco_decoder.wasm', ({env:{MODE:"production"}} /* scrubbed */).url ).toString();
const WASM_JS_URL = new URL( '../libs/draco/draco_wasm_wrapper.js', ({env:{MODE:"production"}} /* scrubbed */).url ).toString();
const JS_URL = new URL( '../libs/draco/draco_decoder.js', ({env:{MODE:"production"}} /* scrubbed */).url ).toString();

const DRACO_GLTF_CONFIG = {
	js: new URL( '../libs/draco/gltf/draco_wasm_wrapper.js', ({env:{MODE:"production"}} /* scrubbed */).url ).toString(),
	wasm: new URL( '../libs/draco/gltf/draco_decoder.wasm', ({env:{MODE:"production"}} /* scrubbed */).url ).toString(),
};
