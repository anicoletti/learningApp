export const planets = [
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/sun',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/mercury',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/venus',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/earth',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/mars',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/jupiter',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/saturn',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/uranus',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/neptune',
  ...
  { 
    ...
    url3D: 'https://eyes.nasa.gov/apps/solar-system/#/pluto',
